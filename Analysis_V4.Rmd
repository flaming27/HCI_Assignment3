...
# Plotting beeswarm and mean error percentage:
```{r}
pd <- position_dodge(0.3) # ensure no overlaps
...
* \\(H_3.2\\): Mobile phone based “remote mouses” have a higher throughput when using two-handed pointing method compared to one-handed pointing method.
